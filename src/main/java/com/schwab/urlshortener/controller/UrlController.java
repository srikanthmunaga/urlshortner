...
public class UrlController {
    ...
    public ResponseEntity<Void> redirect(@PathVariable String shortCode, HttpServletRequest httpRequest) {
        String longUrl = urlService.resolveAndTrack(
                shortCode, clientIp(httpRequest), httpRequest.getHeader("User-Agent"), httpRequest.getHeader("Referer"));
        ...
        urlService.recordClick(shortCode, clientIp(httpRequest), httpRequest.getHeader("User-Agent"),
